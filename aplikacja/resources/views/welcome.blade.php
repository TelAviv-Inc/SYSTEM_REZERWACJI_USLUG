...
<body class="bg-brand-bg text-brand-text font-sans antialiased min-h-screen flex flex-col justify-between">
    ...
    <header class="bg-white border-b border-brand-border w-full">
        <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <!-- Logo + Nazwa -->
            <a href="{{ url('/') }}" class="flex items-center gap-2.5 text-brand-navy font-bold text-base hover:opacity-90 transition-opacity">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('login') }}" class="px-4 py-2 text-sm font-semibold text-brand-accent hover:bg-brand-light-bg rounded-md transition-colors">
                    Zaloguj się
                </a>
                <a href="{{ route('register') }}" class="px-4 py-2 text-sm font-semibold text-white bg-brand-accent hover:bg-brand-hover rounded-md transition-colors shadow-sm">
                    Zarejestruj się
                </a>
            </div>
    ...
    <main class="flex-grow flex flex-col items-center justify-center px-4 py-12">
        ...
        <div class="max-w-xl text-center mb-10">
            ...
            <div class="flex items-center justify-center gap-3">
                <a href="{{ route('register') }}" class="px-6 py-2.5 text-sm font-semibold text-white bg-brand-accent hover:bg-brand-hover rounded-md transition-colors shadow-sm">
                    Zarejestruj się
                </a>
                <a href="{{ route('login') }}" class="px-6 py-2.5 text-sm font-semibold text-brand-text bg-white border border-brand-border hover:bg-brand-light-bg rounded-md transition-colors shadow-sm">
                    Mam już konto
                </a>
            </div>
        </div>
        ...
        <div class="w-full max-w-4xl bg-white rounded-xl border border-brand-border shadow-sm grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-brand-border overflow-hidden">
